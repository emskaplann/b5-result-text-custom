...
adverse to thrill-seeking.`
    },
    {
      facet: 6,
      title: 'Cheerfulness',
      text: `Bu ölçek kişilerin olumlu ruh halini ve duyguları ölçer. Tipik olarak bu ölçekte yüksek puan 
      alan kişiler mutluluk dahil bir dizi olumlu duyguyu(coşku, iyimserlik, neşe, vb.) deneyimlerle. Tam aksine 
      düşük puan alanlar ise bu tarz duyguları sıklıkla deneyimlemeye yatkın değillerdir.`
    }
  ]
}
